...
import kalyan.dream.en.india.web_service.model.starline.StarlineMarkets
...
class StarlineMarketAdapter(private var markets: List<StarlineMarkets>) :
    ...
    class StarlineMarketViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val rootStarItem = view.findViewById<ConstraintLayout>(R.id.root_star_item)
        ...
        fun bind(markets: StarlineMarkets) {
            ...
            if (markets.status == 0) {
                rootStarItem.setBackgroundColor(Color.parseColor("#26ff7979"))
                buttonPlayStarLine.setBackgroundResource(R.drawable.vip_p_button_play_red)
                ...
                rootStarItem.setBackgroundColor(Color.parseColor("#2678e08f"))
                buttonPlayStarLine.setBackgroundResource(R.drawable.vip_button_play_green)
